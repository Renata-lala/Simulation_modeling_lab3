    ...
    public partial class Form1 : Form
    {
        ...
        private void FirstGeneration() {
            for (int i = 0; i < cols; ++i)
            {
                if (field[i, 0] == true)
                {
                    graphics.FillRectangle(Brushes.Turquoise, i * resolution + 1, 0 * resolution + 1, resolution - 1, resolution-1);
        ...
        private void NextGeneration(int j, int iRows)
        {
            for (int i = 0; i < cols; ++i)
            {
                ...
                {
                    graphics.FillRectangle(Brushes.Turquoise, i * resolution + 1, iRows * resolution + 1, resolution - 1, resolution - 1);
